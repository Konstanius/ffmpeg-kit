...
<img src="https://github.com/Konstanius/ffmpeg-kit/raw/main/docs/assets/ffmpeg-kit-icon-v9.png" width="180">
...
applications and 8 prebuilt binary packages available at [Github](https://github.com/Konstanius/ffmpeg-kit/releases),
...
- 8 prebuilt binary packages available at [Github](https://github.com/Konstanius/ffmpeg-kit/releases), [Maven Central](https://search.maven.org), [CocoaPods](https://cocoapods.org), [pub](https://pub.dev) and [npm](https://www.npmjs.com)
- Licensed under `LGPL 3.0` by default, some packages licensed by `GPL v3.0` effectively

### 2. Android

See [Android](https://github.com/Konstanius/ffmpeg-kit/tree/development/android) to learn more about `FFmpegKit` for
`Android`.

### 3. iOS, macOS, tvOS

See [Apple](https://github.com/Konstanius/ffmpeg-kit/tree/development/apple) to use `FFmpegKit` on `Apple` platforms
(`iOS`, `macOS`, `tvOS`).

### 4. Flutter

See [Flutter](https://github.com/Konstanius/ffmpeg-kit/tree/main/flutter/flutter) to learn more about `FFmpegKit` for
`Flutter`.

### 5. Linux

See [Linux](https://github.com/Konstanius/ffmpeg-kit/tree/main/linux) to learn more about `FFmpegKit` for
`Linux`.

### 6. React Native

See [React Native](https://github.com/Konstanius/ffmpeg-kit/tree/main/react-native) to learn more about `FFmpegKit` for
`React Native`.
...
[Building](https://github.com/Konstanius/ffmpeg-kit/wiki/Building) wiki page for the details.
...
[Github](https://github.com/Konstanius/ffmpeg-kit/releases),
...
|:----------------:|:-----------------------------------------------------------------------------------:|:--------------:|:------------:|
|     Flutter      |   [6.0.3](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v6.0.3)    |      6.0       | Sep 19, 2023 |
|   React Native   | [6.0.2](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v6.0.2) |      6.0       | Sep 19, 2023 |
|     Flutter      |   [6.0.2](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v6.0.2)    |      6.0       | Sep 03, 2023 |
|   React Native   | [6.0.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v6.0.1) |      6.0       | Sep 03, 2023  |
|     Flutter      |   [6.0.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v6.0.1)    |      6.0       | Sep 03, 2023 |
|   React Native   | [6.0.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v6.0.0) |      6.0       | Aug 27, 2023 |
|     Flutter      |   [6.0.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v6.0.0)    |      6.0       | Aug 27, 2023 |
|      Android<br>Apple       |         [6.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v6.0)          |      6.0       | Aug 21, 2023 |
|   React Native   | [5.1.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v5.1.0) |     5.1.2      | Oct 02, 2022 |
|     Flutter      |   [5.1.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v5.1.0)    |     5.1.2      | Oct 02, 2022 |
|     Android<br>Apple      |         [5.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v5.1)          |     5.1.2      | Sep 29, 2022 |
|   React Native   | [4.5.2](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v4.5.2) |  4.5-dev-3393  | May 25, 2022 |
|     Flutter      |   [4.5.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v4.5.1)    |  4.5-dev-3393  | Jan 02, 2022 |
|   React Native   | [4.5.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v4.5.1) |  4.5-dev-3393  | Jan 02, 2022 |
|     Android      |       [4.5.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v4.5.1)        |  4.5-dev-3393  | Jan 01, 2022 |
|      Apple       |       [4.5.1](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v4.5.1)        |  4.5-dev-3393  | Dec 30, 2021 |
|     Flutter      |   [4.5.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/flutter.v4.5.0)    |  4.5-dev-2008  | Oct 05, 2021 |
|   React Native   | [4.5.0](https://github.com/Konstanius/ffmpeg-kit/releases/tag/react.native.v4.5.0) |  4.5-dev-2008  | Oct 01, 2021 |
| Android<br>Apple |         [4.5](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v4.5)          |  4.5-dev-2008  | Sep 18, 2021 |
| Android<br>Apple |         [4.4](https://github.com/Konstanius/ffmpeg-kit/releases/tag/v4.4)          |  4.4-dev-3015  | Mar 03, 2021 |
...
A more detailed documentation is available under [Wiki](https://github.com/Konstanius/ffmpeg-kit/wiki).
...
Refer to [Licenses](https://github.com/Konstanius/ffmpeg-kit/wiki/Licenses) to see the licenses of all libraries.
[Trademark](https://github.com/Konstanius/ffmpeg-kit/wiki/Trademark) lists the trademarks used in the `FFmpegKit`
documentation.
...
See our [CONTRIBUTING](https://github.com/Konstanius/ffmpeg-kit/blob/main/CONTRIBUTING.md) guide.
